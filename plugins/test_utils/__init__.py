...
atest = Plugin.on_msg(checker=SU_CHECKER, parser=PARSER_GEN.gen(["异步测试", "atest", "async-test"]))
test_n = Plugin.on_msg(checker=SU_CHECKER, parser=PARSER_GEN.gen(["测试统计", "testn", "test-stat"]))
